...
__private_extern__ void rgb2hsl(float r, float g, float b, float &h, float &s, float &l);

__private_extern__ void hsl2rgb(float h, float s, float l, float &r, float &g, float &b);
...
// 1 does the opposite.
__private_extern__ void hslTween(float h1, float s1, float l1,
					 float h2, float s2, float l2, float tween, int direction,
					 float &outh, float &outs, float &outl);

__private_extern__ void rgbTween(float r1, float g1, float b1,
